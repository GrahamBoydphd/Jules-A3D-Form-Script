...
function onFormSubmit(e) {
  ...
  let emailBody = `Hi ${R_first_name},\n\n`;
  emailBody += `Here is the first level evaluation of whether your foundations are strong enough to support your ${R_business_intent} business intention for your company ${R_company_name}.\n\n`;
  emailBody += `So, how strong are your foundations, on a scale from 0 (no agency) to 5 (full agency) in each dimension? To build a truly viable future economy only full agency in all three dimensions is strong enough. Scoring 0 to 2 is inadequate, scoring 3 is marginal, scoring 4 is good, and scoring 5 is excellent! Of course even a score of 3 puts you in the top 1% vs. all other companies. So with 4 or 5 you really are pushing against the limits of today’s beliefs.\n\n`;

  if (!R_only_self_assessment_flag && !R_only_incorporation_flag) {
    emailBody += `* For the ${DAO_form} dimension your score is: ${Z_scored_level} ${Agency_name[Z_scored_level]}\n`;
    emailBody += `* For the work / organisation design dimension your score is: ${Y_scored_level} ${Agency_name[Y_scored_level]}.\n`;
    emailBody += `* For the human dimension your score is: ${X_scored_level} ${Agency_name[X_scored_level]}.\n\n`;
  } else if (!R_only_self_assessment_flag && R_only_incorporation_flag) {
    emailBody += `Because you did the full healthcheck for the ${DAO_form} dimension only, and the self-assessment for the work and human dimensions, I can only compare your ${DAO_form} self-assessment and full evaluation. If you want a comparison between your actual strength and your perception of the work and human dimensions, please edit the form and fill in these dimensions in.\n\n`;
    emailBody += `* For the ${DAO_form} dimension your score is: ${Z_scored_level} ${Agency_name[Z_scored_level]}\n`;
    emailBody += `* For the work / organisation design dimension your self-assessment is: ${Y_self_assessment_level} ${Agency_name[Y_self_assessment_level]}\n`;
    emailBody += `* For the human dimension your self-assessment is: ${X_self_assessment_level} ${Agency_name[X_self_assessment_level]}\n\n`;
  } else if (R_only_self_assessment_flag) {
    emailBody += `As you chose to only provide your self-assessment we cannot give you any guidance on possible discrepancies between your foundation’s actual strength versus your beliefs about your foundation’s strength.\n\n`;
    emailBody += `* For the ${DAO_form} dimension your self-assessment is: ${Z_self_assessment_level} ${Agency_name[Z_self_assessment_level]}\n`;
    emailBody += `* For the work / organisation design dimension your self-assessment is: ${Y_self_assessment_level} ${Agency_name[Y_self_assessment_level]}\n`;
    emailBody += `* For the human dimension your self-assessment is: ${X_self_assessment_level} ${Agency_name[X_self_assessment_level]}\n\n`;
  }
  ...
  emailBody += `\nGiven your business intention is ${R_business_intent} ,\n`;
  ...
  if (regenerativeIntents.includes(R_business_intent) && Z_scored_level === 5 && Y_scored_level === 5 && X_scored_level === 5) {
    emailBody += "you have, or are building, the strongest foundations around. Well done! If we’re not already in contact, we’d love to get to know you and your company better.\n";
  } else if (regenerativeIntents.includes(R_business_intent) && Z_scored_level === 4 && Y_scored_level >= 4 && X_scored_level >= 4) {
    emailBody += "your " + DAO_form + " is almost strong enough; and your work / organisation design is strong enough; and your human foundation is strong enough. Well done! You’re likely building foundations way stronger than most! To find out where you can get even stronger, buy the follow-on consulting session.\n";
  } else if (["Regenerative", "Sustainable", "Circular", "Net Positive", "Impact"].includes(R_business_intent)) {
      if (Z_scored_level === 3) {
          emailBody += "even though you’re incorporating in a new way that superbly solves many of the problems business causes, you’re still within the old paradigm. Your incorporation foundation’s strength is marginal vs. your intention to be truly " + R_business_intent + ". Your incorporation form has weakness that will eventually fail under the load of achieving your intention, or you will weaken your intent to match your incorporation foundations.\n";
      } else if (Z_scored_level <= 2) {
          emailBody += "your incorporation foundation’s strength is inadequate, and has serious weakness that will eventually fail under the load of achieving your intention, or you will weaken your intent to match your incorporation foundations.\n";
      }
      if (Y_scored_level >= 4) {
          emailBody += "your organisation design is strong enough, but will likely be weakened over time by your incorporation; ";
      } else if (Y_scored_level >= 2) {
          emailBody += "your organisation design foundation’s strength is marginal; ";
      } else {
          emailBody += "your organisation design foundation’s strength is too weak and will break under the load, or you will weaken your intent to match your foundations.\n";
      }
      if (X_scored_level >= 4) {
          emailBody += "your human foundation is strong enough, but will likely be weakened over time by your incorporation. ";
      } else if (X_scored_level >= 2) {
          emailBody += "your human foundation’s strength is marginal; ";
      } else {
          emailBody += "your human foundation’s strength is too weak and will break under the load, or you will weaken your intent to match your foundations.\n";
      }
      emailBody += "Your intentions are sound, and you’re putting in your best efforts, but there are proven ways to do better. To find out where you can get your foundations even stronger, and reduce the risk of mission creep or your foundations breaking, buy the follow-on consulting session.\n";
      ...
      if (Z_scored_level === 3) {
          emailBody += "even though you’re incorporating in a new way that superbly solves many of the problems business causes, and that may well be strong enough for you, you’re still within the old paradigm. Your incorporation foundation’s strength may still hamper your intention to be truly " + R_business_intent + ".\n";
      } else if (Z_scored_level <= 2) {
          emailBody += "your incorporation foundation’s strength is inadequate, and has serious weakness that will eventually fail under the load of achieving your intention, or you will weaken your intent to match your incorporation foundations.\n";
      }
      if (Y_scored_level >= 4) {
          emailBody += "your organisation design is strong enough, but may be weakened over time by your incorporation; ";
      } else if (Y_scored_level >= 2) {
          emailBody += "your organisation design foundation’s strength is probably strong enough, though you’d definitely benefit by making it stronger; ";
      } else {
          emailBody += "your organisation design foundation’s strength is too weak and will break under the load, or you will weaken your intent to match your foundations.\n";
      }
      if (X_scored_level >= 4) {
          emailBody += "your human foundation is strong enough; ";
      } else if (X_scored_level >= 2) {
          emailBody += "your human foundation’s strength is probably strong enough, though you’d definitely benefit by making it stronger; ";
      } else {
          emailBody += "your human foundation’s strength is too weak and will break under the load, or you will weaken your intent to match your foundations.\n";
      }
      if (Z_scored_level >= 3 && Y_scored_level >= 3 && X_scored_level >= 3) {
          emailBody += "Your intention to make the world a better place is admirable, and your foundations may well be strong enough for the load! To get a more thorough assessment, and to get a plan on how you can use proven ways to do better, with less stress for yourself, buy the follow-on consulting session.\n";
      } else {
          emailBody += "Your intention to make the world a better place is admirable, but your foundations may well break under the load! To get a more thorough assessment, and to get a plan on how you can use proven ways to do better, with less stress for yourself, buy the follow-on consulting session.\n";
      }
  } else if (["Maximise shareholder value", "Profitable exit for investors, founders, and key staff"].includes(R_business_intent)) {
      if (Z_scored_level === 3) {
          emailBody += "you’re incorporating in a new way that superbly solves many of the problems business causes. ";
      } else if (Z_scored_level === 2) {
          emailBody += "your incorporation foundation’s strength as a cooperative may not suit your intention, one of the alternatives may be better for you; ";
      } else if (Z_scored_level === 1) {
          emailBody += "your incorporation foundation’s strength as an employee-owned trust may be fine for your intention, but one of the alternatives may be better for you; ";
      } else {
          emailBody += "your incorporation foundation’s strength may be strong enough for your intention over the short term, but it has weaknesses that may well break under the strain of the volatile business context of the near future; ";
      }
      if (Y_scored_level >= 4) {
          emailBody += "your organisation design though is strong enough, but will be dragged down over time by your incorporation; ";
      } else if (Y_scored_level >= 2) {
          emailBody += "your organisation design foundation’s strength is marginal, and may be negatively impacted by your incorporation foundation; ";
      } else {
          emailBody += "your organisation design foundation’s strength is too weak and will break under the load. ";
      }
      if (X_scored_level >= 4) {
          emailBody += "your human foundation is strong enough, but likely be dragged down over time by your incorporation; ";
      } else if (X_scored_level >= 2) {
          emailBody += "your human foundation’s strength is marginal; ";
      } else {
          emailBody += "your human foundation’s strength is too weak and will break under the load. ";
      }
      if (Z_scored_level >= 3 && Y_scored_level >= 3 && X_scored_level >= 3) {
          emailBody += "You seem to be in the paradox between a desire to build a future-fit company, and the old paradigm of investor primacy! To get a more thorough assessment, and to get a plan on how you can use proven ways to transcend and integrate your polarities, with less stress for yourself, buy the follow-on consulting session.\n";
      } else {
          emailBody += "To get a more thorough assessment, and to get a plan on how you can use proven ways to up your game, with less stress for yourself, buy the follow-on consulting session.\n";
      }
  }
  ...
  if (Z_self_assessment_level !== -1) {
    if (Z_scored_level === Z_self_assessment_level) {
      emailBody += "Your self-assessment of your level of incorporation and our initial automated evaluation are the same!\n";
    } else if (Z_scored_level > Z_self_assessment_level) {
      emailBody += "Your self-assessment of your level of incorporation is lower than our initial automated evaluation! Are you a little harsh on yourself at times?\n";
    } else {
      emailBody += "Your self-assessment of your level of incorporation is higher than our initial automated evaluation! Are you at risk of being surprised by your foundations breaking when you most need them?\n";
    }
  }
  ...
  if (Y_self_assessment_level !== -1) {
    if (Y_scored_level === Y_self_assessment_level) {
      emailBody += "Your self-assessment of your work / organisation design level and our initial automated evaluation are the same!\n";
    } else if (Y_scored_level > Y_self_assessment_level) {
      emailBody += "Your self-assessment of your work / organisation design level is lower than our initial automated evaluation! Are you a little harsh on yourself at times?\n";
    } else {
      emailBody += "Your self-assessment of your work / organisation design level is higher than our initial automated evaluation! Are you at risk of being surprised by your work / organisation design foundations breaking when you most need them?\n";
    }
  }

  if (X_self_assessment_level !== -1) {
    if (X_scored_level === X_self_assessment_level) {
      emailBody += "Your self-assessment of your human foundation’s level and our initial automated evaluation are the same!\n";
    } else if (X_scored_level > X_self_assessment_level) {
      emailBody += "Your self-assessment of your human foundation’s level is lower than our initial automated evaluation! Are you a little harsh on yourself at times?\n";
    } else {
      emailBody += "Your self-assessment of your human foundation’s level is higher than our initial automated evaluation! Are you at risk of being surprised by your human foundations breaking when you most need them?\n";
    }
  }

  emailBody += "\n";
  emailBody += "You can find more information about the incorporation dimension in my YouTube channel, especially in <a href='https://www.youtube.com/playlist?list=PL35xWnDyNa_97x7_I06ytop8Jg9PfGcDL'>this playlist</a> for entrepreneurs. You can also take <a href='https://www.evolutesix.com/regenerative-foundations-online'>this online course</a> and read about the three foundational dimensions in <a href='https://drive.google.com/file/d/1WB2nOdgdrcptWHKrd7jThnIUOtVqfNBV/view?usp=sharing'>this extract</a> from my book Rebuild the Economy, Leadership, and You.\n\n";
  ...
  if (ergodicity_response === "Skill and effort are the primary drivers of business performance, business is a meritocracy. We only have robust ways of maximising the business outcomes of skill and effort") {
    ...
    emailBody += "You seem to have an excellent understanding of the relationship between skills / effort and unpredictability, which you seem to have used to build solid foundations to maximise the outcomes from each. Of course, there may well be areas where you can do even better!\n\n";
  }

  if (theory_x_y_response === "people are inherently lazy and must be controlled, incentivised, and threatened") {
    emailBody += "You also most likely have significant upside potential for better results by strengthening the way your foundations increase people’s inner motivations. This is well-proven, especially in volatile times, to lead to faster, more effective responses to events. And so delivers better outcomes for you and your investors.\n\n";
  } else if (theory_x_y_response === "people are intrinsically self-motivated and creative") {
    emailBody += "You’ve grasped the power of tapping into intrinsic motivation! ";
    if (Z_scored_level >= 4 && Y_scored_level >= 4 && X_scored_level >= 4) {
        emailBody += "And you seem to have built the right foundations to maximise people’s (and teams’) agency to maximise their intrinsic motivation and turn it into excellent results! Well done! Would you say no to a better way?\n\n";
    } else if (Z_scored_level >= 1 && Y_scored_level >= 2 && X_scored_level >= 2) {
        emailBody += "And you seem to have built some foundations towards enabling people’s (and teams’) agency to maximise their intrinsic motivation and turn it into excellent results, but there are well-proven ways of building far more enabling foundations.\n\n";
    } else {
        emailBody += "But you seem to have built foundations that fall short of what you need to really enable people’s (and teams’) agency to maximise their intrinsic motivation and turn it into excellent results. There are well-proven ways of building far more enabling foundations.\n\n";
    }
  }

  if (growth_mindset_response === "you either are “good” at something or not - mostly people just cannot learn new things") {
    emailBody += "Since you seem to believe that people can’t develop very much, regardless of the support given to them, you’re likely going to carry higher costs and higher risks as your business scales. Also, in the face of our ever more volatile and unpredictable world, slower reaction times and weaker innovation. You would be well served by asking yourself what has led to your beliefs about people, and how confident you are that they are absolutely true, everywhere and always, for everyone.\n\n";
    ...
    emailBody += "Your beliefs about people’s capacity to develop in response to challenges, given the right support, are powerful enablers for success! So long as you put in place both ways of recognising each person’s development edge (including your own!) and the scaffolding each person needs, your chances of success are better than most!\n\n";
  } else if (growth_mindset_response === "you can learn new things easily by yourself") {
    emailBody += "Your beliefs about people’s capacity to develop in response to challenges are enablers for success. However, because you seem to expect them to do so without systemic support from the organisation you’re likely limiting development (yours as well) to the zone of self-supported development. To develop at one’s developmental edge requires both ways of recognising each person’s development edge (including your own!) and the scaffolding each person needs. Only if you do that will your chances of success be better than most!\n\n";
  }
  ...
  if (technical_vs_adaptive_response === "all challenges can be overcome with perseverance and learning/hiring new skills, buying new technology") {
    ...
    if (X_scored_level < 4 || Y_scored_level < 4) {
        emailBody += "Improvement is especially important for the growing volatility and unpredictability we’re already experiencing, and that we expect to increase with time.\n\n";
    }
  }

  emailBody += `${R_first_name}, there’s a lot more you can get out of the data you’ve given us in a strategic dialogue. We’ve heard time and time again from other people in your ${R_role} role “I didn’t even know that that was possible”. If you’re sure that nothing of value can come from one initial consulting session with us, then we in Evolutesix wish you all success, and hope to read good news about you one day in the headlines! Otherwise <a href="https://www.evolutesix.com/legal-od-strong-enough">take our initial consulting session</a>.\n\n`;

  emailBody += "Thank you for your time filling in this assessment!\n";
  if (feedback_comments.length > 0) {
    emailBody += "We appreciate the feedback you have already given us while filling in the form. We’d love to hear more from you, especially if you have any questions, or any additional feedback on the assessment itself or this email.\n";
  } else {
    emailBody += "We’d love to hear from you, especially if you have any questions, or any feedback on the assessment itself or this email.\n";
  }

  emailBody += "\n\n--- Debug Information ---\n";
  emailBody += "Constants:\n";
  emailBody += `R_first_name: ${R_first_name}\n`;
  emailBody += `R_last_name: ${R_last_name}\n`;
  emailBody += `R_company_name: ${R_company_name}\n`;
  emailBody += `R_role: ${R_role}\n`;
  emailBody += `R_business_intent: ${R_business_intent}\n`;
  emailBody += `R_sector: ${R_sector}\n`;
  emailBody += `R_exit_strategy: ${R_exit_strategy}\n`;
  emailBody += `R_incorporated_flag: ${R_incorporated_flag}\n`;
  emailBody += `Agency_name: ${JSON.stringify(Agency_name)}\n`;
  emailBody += `R_DAO_flag: ${R_DAO_flag}\n`;
  emailBody += `DAO_form: ${DAO_form}\n`;
  emailBody += `R_only_self_assessment_flag: ${R_only_self_assessment_flag}\n`;
  emailBody += `Z_self_assessment_text: ${Z_self_assessment_text}\n`;
  emailBody += `Z_self_assessment_level: ${Z_self_assessment_level}\n`;
  emailBody += `Y_self_assessment_text_long: ${Y_self_assessment_text_long}\n`;
  emailBody += `Y_self_assessment_text: ${Y_self_assessment_text}\n`;
  emailBody += `Y_self_assessment_level: ${Y_self_assessment_level}\n`;
  emailBody += `X_self_assessment_text_long: ${X_self_assessment_text_long}\n`;
  emailBody += `X_self_assessment_text: ${X_self_assessment_text}\n`;
  emailBody += `X_self_assessment_level: ${X_self_assessment_level}\n`;
  emailBody += "\nVariables:\n";
  emailBody += `Y_running_total: ${Y_running_total}\n`;
  emailBody += `X_running_total: ${X_running_total}\n`;
  emailBody += `z_level_scores: ${JSON.stringify(z_level_scores)}\n`;
  emailBody += `Z_scored_level: ${Z_scored_level}\n`;
  emailBody += `Y_scored_level: ${Y_scored_level}\n`;
  emailBody += `X_scored_level: ${X_scored_level}\n`;
  emailBody += `R_only_incorporation_flag: ${R_only_incorporation_flag}\n`;
